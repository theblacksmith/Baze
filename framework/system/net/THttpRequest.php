...
Prado::using('system.web.ui.TUrlManager');
...
class THttpRequest extends TApplicationComponent implements IteratorAggregate,ArrayAccess,Countable,IModule
{
	 ...
	 */
	public function getBazeUrl($forceSecureConnection=false)
	{
	...
	{
		return $this->getBazeUrl($forceSecureConnection) . $this->getApplicationUrl();
	}
	 ...
	 * You may obtain an absolute URL by prepending the constructed URL with {@link getBazeUrl BazeUrl}.
	...
	{
		Prado::trace("Resolving request from ".$_SERVER['REMOTE_ADDR'],'system.web.ui.THttpRequest');
