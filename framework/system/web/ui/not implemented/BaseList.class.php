 ...
 * @package Baze.classes.web
 */
abstract class BaseList extends InteractiveContainer
{
	/**#@+
	 * List Properties
	 *
	 ...
	 */
	public function addChild(ListItem $object, $toFirst = false)
	{
	...
	{
		return '<'.$this->listType.' '.$this->getPropertiesList().' >'.NL;
	}
