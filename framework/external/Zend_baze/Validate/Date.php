 ...
 */
import('external.Zend.Validate.Abstract');
...
class Zend_Validate_Date extends Zend_Validate_Abstract
{
    ...
    {
        if ($locale !== null) {
            import('external.Zend.Locale');
            if (!Zend_Locale::isLocale($locale)) {
                import('external.Zend.Validate.Exception');
    ...
    {
        try {
            import('external.Zend.Locale.Format');
