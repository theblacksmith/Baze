...
// @requires System.lang.functions;
...
class Browscap
{
	...
	{	
		...
		foreach ($browser as $key => $value) {
			$array[strToCamelCase($this->_properties[$key])] = $value;
		}
	...
	private function _getRemoteIniFile($url, $path)
	{
		...
		// added by Saulo Vallory for Baze project
		$content = str_replace('CDF', 'cdf', $content);
		$content = str_replace('AOL', 'aol', $content);
		$content = str_replace('VBScript', 'vbScript', $content);
		// end of addition
